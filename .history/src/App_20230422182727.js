...
return (
    <div className="bg-white">
        <header className="App-header">
            ...
            <p className="text-center w-24" >Don't take too long in the shower! With Soap Opera you pick the playlist and we pick the best songs to limit your water waste</p>
            {!token ?
